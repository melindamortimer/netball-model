...
# BetsAPI team names differ from Champion Data's squad names.
# Keys are lowercased BetsAPI names, values are canonical Champion Data names.
...
def normalise_team(name: str) -> str | None:
    """Map a BetsAPI team name to the canonical Champion Data name."""
